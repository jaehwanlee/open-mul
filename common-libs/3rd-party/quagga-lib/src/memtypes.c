...
struct memory_list memory_list_kulvisor[] = //NAB_23122011
{
  { MTYPE_KULVISOR_CONTEXT,         "Kulvisor context"          },
  { MTYPE_KULVISOR_GUEST,           "Kulvisor guest"            },
  { MTYPE_KULVISOR_GUEST_NAME,      "Kulvisor guest name"       },
  { MTYPE_KULVISOR_GUEST_VCONN_NAME,"Kulvisor guest name"       },
  { MTYPE_KULVISOR_GUEST_SWITCH,    "Kulvisor guest-switch"     },
  { MTYPE_KULVISOR_GUEST_FLOWSPACE, "Kulvisor guest flowspace"  },
  { MTYPE_KULVISOR_SWITCH,          "Kulvisor switch"           },
  { MTYPE_KULVISOR_SWITCH_NAME,     "Kulvisor switch name"      },
  { MTYPE_KULVISOR_SWITCH_HOSTNAME, "Kulvisor switch hostname"  },
  { MTYPE_KULVISOR_XID_TRANS,       "Kulvisor transaction-id"   },
  { MTYPE_KULVISOR_FLOW_MATCH,      "Kulvisor flow-match"       },
  { MTYPE_KULVISOR_FLOW_MOD,        "Kulvisor flow-mod"         },
  { MTYPE_KULVISOR_FLOW_INSTRUCTION,"Kulvisor flow-instruction" },
  { MTYPE_KULVISOR_ACTION,          "Kulvisor flow-action"      },
  { MTYPE_KULVISOR_TOKEN_BUCKET,    "Kulvisor token bucket"     },
  { MTYPE_KULVISOR_TMP,             "Kulvisor TMP"              },
  { -1,                             NULL                        },
};
...
struct mlist mlists[] __attribute__ ((unused)) = {
  ...
  { memory_list_bgp,	"BGP"	},
  { memory_list_kulvisor,"KULVISOR"	}, //NAB_23122011
  { NULL, NULL},
};
